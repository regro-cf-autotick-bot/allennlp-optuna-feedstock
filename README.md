About allennlp-optuna-feedstock
===============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/allennlp-optuna-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11654&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/allennlp-optuna-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `allennlp-optuna` can be installed with `conda`:
...
```
mamba install allennlp-optuna
```

It is possible to list all of the versions of `allennlp-optuna` available on your platform with `conda`:
...
```
mamba search allennlp-optuna --channel conda-forge
```
...
mamba repoquery search allennlp-optuna --channel conda-forge

# List packages depending on `allennlp-optuna`:
mamba repoquery whoneeds allennlp-optuna --channel conda-forge

# List dependencies of `allennlp-optuna`:
mamba repoquery depends allennlp-optuna --channel conda-forge
```
